/* thunarx-3.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Thunarx", gir_namespace = "Thunarx", gir_version = "3.0", lower_case_cprefix = "thunarx_")]
namespace Thunarx {
	[CCode (cheader_filename = "thunarx.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "thunarx_file_info_list_get_type ()")]
	[Compact]
	...
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_menu_get_type ()")]
	...
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_menu_item_get_type ()")]
	...
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_property_page_get_type ()")]
	...
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_provider_factory_get_type ()")]
	...
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_provider_module_get_type ()")]
	...
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_renamer_get_type ()")]
	...
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_file_info_get_type ()")]
	...
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_menu_provider_get_type ()")]
	public interface MenuProvider : GLib.Object {
	}
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_preferences_provider_get_type ()")]
	public interface PreferencesProvider : GLib.Object {
	}
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_property_page_provider_get_type ()")]
	public interface PropertyPageProvider : GLib.Object {
	}
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_provider_plugin_get_type ()")]
	public interface ProviderPlugin : GLib.Object {
		public abstract void add_interface (GLib.Type instance_type, GLib.Type interface_type, [CCode (type = "const GInterfaceInfo *")] GLib.InterfaceInfo? interface_info);
	...
	[CCode (cheader_filename = "thunarx.h", type_id = "thunarx_renamer_provider_get_type ()")]
	public interface RenamerProvider : GLib.Object {
	}
	[CCode (cheader_filename = "thunarx.h", cname = "THUNARX_FILESYSTEM_INFO_NAMESPACE")]
	public const string FILESYSTEM_INFO_NAMESPACE;
	[CCode (cheader_filename = "thunarx.h", cname = "THUNARX_FILE_INFO_NAMESPACE")]
	public const string FILE_INFO_NAMESPACE;
	[CCode (cheader_filename = "thunarx.h", cname = "THUNARX_MAJOR_VERSION")]
	public const int MAJOR_VERSION;
	[CCode (cheader_filename = "thunarx.h", cname = "THUNARX_MICRO_VERSION")]
	public const int MICRO_VERSION;
	[CCode (cheader_filename = "thunarx.h", cname = "THUNARX_MINOR_VERSION")]
	public const int MINOR_VERSION;
	[CCode (cheader_filename = "thunarx.h")]
